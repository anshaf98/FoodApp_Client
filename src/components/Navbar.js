...
import { AiOutlineClose, AiOutlineWallet, AiFillTags } from "react-icons/ai";
  ...
  return (
    <div className="max-w-[1640px] mx-auto flex justify-between items-center p-4">
      ...
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-2xl sm:text-3xl lg:text-4xl gap-5">
          Best <span className="font-bold">Eats</span>
        </h1>
        <div className="hidden lg:flex bg-gray-200 text-[14px] rounded-full p-1 items-center">
      ...
      >
        ...
        <nav>
          <ul className="flex flex-col p-4 text-gray-800">
            ...
            <li className="text-xl py-4 flex">
              <FaHandsHelping size={25} className="mr-4" /> Help
            </li>
            <li className="text-xl py-4 flex">
